...
type StringToUnion<T extends string> = T extends `${infer Char}${infer Rest}` ? Char | StringToUnion<Rest> : never

type HelloUnion = StringToUnion<'hello'> // "" | "h" | "e" | "l" | "o"
type HelloTuple = Chars<'hello'> // ["h", "e", "l", "l", "o"]
